...
- **Scan-Seite:** Kein separater Seitenkopf — **Neuer Scan** + Beschreibung stehen in der Konfigurationskarte (`isAmcScanPageHeaderEnabled()` → `false`). Auf Mobile kein horizontales Padding (`isAmcMobileMainFlushHorizontal()` für `/scan`).
