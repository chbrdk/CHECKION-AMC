...
- **Scan-Ergebnisse (Mobile):** 9 Ansichten als Dropdown; Header mit Score; Issue-Filter als Selects; Sticky Action Bar (PDF + Gerätewechsel); Karten-Innenpadding auf Flush-Pages (`components/results/*`, `components/amc/AmcResponsiveTabs.tsx`).
